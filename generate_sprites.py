...
BEAT_PROMPTS = {
    ...
    # wedged in his mouth."
    "curry_emerge": (
        "pixel art WIDE FULL-BODY side-on establishing shot of the open doorway of an INDIAN GROCER "
        ...
        "bright orange CURRY POWDER, GARAM MASALA jars, bags of cumin seeds, spilling out the top, "
        "a half-eaten SAMOSA wedged in the corner of his mouth, "
        ...
        "packets of rice and spice stacked outside under the awning (NO readable text on signage — "
    ...
    "brenno_plead": (
        ...
        "7-Eleven glow further down (only shape recognition — NO readable text on any signage), "
        "fairy lights strung across the street overhead twinkling, warm orange streetlamp pool, "
        "deep navy night sky above, "
        "16-bit pixel art GRITTY realistic mid-shot with HIGH DETAIL on Brenno's pleading face + "
        "hands, the desperate BEGGING moment, Western Sydney post-race night atmosphere"
    ),
    ...
    "brenno_yew_hype": (
        ...
        "fully into the upper frame, masculine adult face visible (NOT cute kid face NOT chibi), "
        ...
        "the OTHER HAND in a clenched FIST punching the air, bouncing on his toes, body language is "
        "PURE STOKED ESHAY HYPE, "
        "small stylised lightning-bolt + star sparkle pixel-art effects radiating around his raised arms, "
        "BACKGROUND: Khoa's WHITE PEARL Nissan R32 GT-R Skyline parked side-on behind him (just front quarter "
        "visible at the edge of frame), Cabra Maccas drive-thru carpark with the iconic golden ARCHES "
        "silhouette on a tall pole glowing yellow (NO readable text), painted white parking bay lines, "
        "warm amber + slight magenta neon glow from the carpark lamps, "
        "scattered abandoned shopping trolleys further off, deep navy night sky above, "
        "16-bit pixel art GRITTY realistic mid-shot with HIGH DETAIL on Brenno's hyped pose + raised "
        "brown paper bag, the POST-DEAL ESHAY CELEBRATION moment"
    ),
    ...
    "khoa_spotlight_brief": (
        ...
        "Nissan R32 GT-R Skyline parked side-by-side in adjacent painted parking bays, both cars dark and "
    ...
    "khoa_slick_celebration": (
        "pixel art MEDIUM-WIDE SHOT view through the open driver's-side window of the player's car looking "
        "OUT at " + KHOA_DESC + ", "
        "standing on the asphalt beside his parked white pearl R32 GT-R Skyline in the Cabra Maccas carpark "
        "at night, FULL TORSO and head visible (NOT just a face close-up — show his shirt, watch, and "
        "the open R32 door in frame), Khoa leaning casually on his open R32 driver's door, "
        ...
        "his other hand resting casually on the R32 door, body language is COOL SMOOTH-OPERATOR pride, "
        ...
        "the white R32 body visible behind Khoa with its deep-dish gunmetal wheels, "
    ...
    "brenno_bullshitting": (
        ...
        "ONE HAND pointing at his own chest with thumb (the 'me, this guy, real one' boastful "
        "gesture), the OTHER HAND making an EMPHATIC THREE-FINGER COUNT pointing up + out as he "
        "lists his bullshit achievements, elbows out, mouth open mid-monologue showing teeth, "
        "small stylised motion-line bursts around his pointing hand emphasising the smack-talking "
        "energy, "
        ...
        "on any signage), low-slung brick restaurant facade with lit dining-room windows, to one "
        "side a Lebanese kebab shop with a stylised kebab-on-spit silhouette in magenta neon, "
        ...
        "warm amber streetlamps just turning on with soft pools on the asphalt, "
        "16-bit pixel art GRITTY realistic mid-shot with HIGH DETAIL on Brenno's smack-talking pose, "
        "the iconic 'I run with the Mexican Hoon Cartel I SWEAR AY' tall-tale moment"
    ),
