...
BEAT_PROMPTS = {
    ...
    "brenno_beemer_intro": (
        "pixel art WIDE SHOT view of Blacktown Maccas carpark at dusk, "
        "in the foreground centre Brenno (skinny pale ginger Australian eshay teenager, "
        "NAVY BLUE NIKE TN CAP pulled low with yellow swoosh, MUSTARD YELLOW JUMPER, navy "
        "tracksuit pants tucked into white tube socks, white rubber slides, freckles, "
        "patchy ginger stubble) standing beside his parked broken-down DEEP BLUE BMW E36 sedan, "
        "Brenno is FACING the camera mid-rant — BOTH ARMS THROWN OUT WIDE to the sides in animated "
        "ESHAY GESTURE OF FRUSTRATION (the iconic 'BRA WHAT DO YOU RECKON' pose), elbows out, "
        "palms up, mouth open mid-sentence, body slightly leaned forward, "
        "the BMW E36 parked directly behind him taking up the centre-right of the frame — "
        "BONNET PROPPED OPEN with a wisp of THICK WHITE/GREY ENGINE SMOKE curling up out of the "
        "engine bay (the smoke animation will be the focal motion of the gif), "
        "the E36 is faded blue paint with a dented front quarter, slammed coilovers, black "
        "aftermarket wheels, BEEMER sticker on the boot, looks WELL cooked, "
        "BACKGROUND: classic Blacktown Maccas drive-thru — bright golden MCDONALDS ARCHES sign on a "
        "tall pole glowing yellow, the restaurant facade with lit dining-room windows, "
        "a Lebanese KEBAB SHOP next door with magenta neon signage and a vertical kebab spit visible "
        "through its window, scattered gum trees silhouetted on the horizon, "
        "DRAMATIC dusk sky — deep red and burnt orange gradient on the horizon transitioning up to "
        "navy at the top of the frame, a few early stars appearing, "
        "warm streetlamps just starting to come on with amber pools on the asphalt, "
        "painted parking bay lines on the asphalt, "
        "16-bit pixel art wide composition with HIGH DETAIL on Brenno's gesturing pose + the smoking "
        "Beemer bonnet, the iconic 'WHAT DO YOU RECKON' opening moment, "
        "Western Sydney late-arvo carpark drama atmosphere"
    ),
