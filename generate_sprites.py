...
BEAT_PROMPTS = {
    ...
    "khoa_deal_hand": (
        ...
        "the FOCAL ELEMENT is Khoa's HAND HOLDING UP a small CLEAR ZIP-LOCK BAG of STICKY GREEN "
        "CANNABIS / MARIJUANA BUDS — a translucent plastic baggie loosely PACKED FULL with proper "
        "cannabis nug-shaped flower buds (NOT cabbages, NOT brussels-sprouts, NOT spherical balls — "
        "iconic ELONGATED CONE-SHAPED CANNABIS NUGS with shaggy frosted texture), "
        "each individual bud has the iconic CANNABIS BUD SHAPE — irregular ELONGATED CONE / "
        "TEARDROP form with a pointed tip, COVERED IN SHAGGY ORANGE-RED PISTIL HAIRS curling out "
        "all over the surface (the hallmark cannabis stigma hairs), DENSE GREEN BUD STRUCTURE "
        "underneath with visible small leaf curls (sugar leaves) wrapped around the calyxes, "
        "FROSTED WITH WHITE TRICHOME CRYSTALS catching the light like a dusting of sticky sugar, "
        "deep forest green colour with hints of darker purple at the base of the buds, "
        "five or six of these nugget-shaped buds loosely packed inside the baggie filling it about "
        "three-quarters full, "
        "the baggie has the SHAGGY ORGANIC GRASS-LIKE TEXTURE clearly readable through the clear "
        "plastic (the appearance unmistakably reads as PROPER CANNABIS / WEED, NOT vegetables), "
        "the baggie tilted at an angle to camera so the nug texture reads clearly, "
    ...
    "evo_gps_penrith_route": (
        ...
        "the player visible from BEHIND in the driver's seat (NOT face — back of head and "
        "shoulders only), short cropped dark brown hair, BLACK ZIP-UP HOODIE on the shoulders, "
        "both hands on the BLACK aftermarket MOMO-style STEERING WHEEL in a 9-and-3 grip, "
